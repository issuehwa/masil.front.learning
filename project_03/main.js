...
const button = document.getElementById('button');  // HTML 요소 중에 id가 button인 요소를 선택해서 변수 button 안에 대입
const input = document.getElementById('input');  // HTML 요소 중에 id가 input인 요소를 선택해서 변수 input 안에 대입
const list = document.getElementById('list');    // HTML 요소 중에 id가 list인 요소를 선택해서 변수 list 안에 대입
let count = 1;  // count 변수에 숫자 1을 할당

// 리스트 데이터
let listData = [111, 2222, 333];
